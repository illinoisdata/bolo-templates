...
# Massively Multilingual Speech (MMS): German, Standard Text-to-Speech

This repository contains the **German, Standard (deu)** language text-to-speech (TTS) model checkpoint.
